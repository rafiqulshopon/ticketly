...
// Hand-written against the unified `radix-ui` package to match the rest of the
// UI primitives (see avatar.tsx, dialog.tsx), rather than the per-primitive
// @radix-ui/* packages the shadcn CLI emits by default.
